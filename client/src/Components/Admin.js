...
class Admin extends React.Component {
  ...
  debugFiller() {
    ...
    this.setState({
      instituteAddress: "",
      instituteName: "Grandida University",
      instituteAcronym: "GRD",
      instituteWebsite: "https://www.grandida.edu",
      instituteCourses: new Map([
        [1, "Computer Science"],
        [2, "Solidity Development"],
        [3, "Blockchain systems and Cryptography"],
  ...
  render() {
    ...
    return (
      <>
        <div style={{ background: "#800020", marginTop:"-25px" }}>
        {renderLoading ? (
          ...
          <>
            <Typography
              ...
              // color="white"
              align="center"
              style={{ marginTop: "30px", color:"white", paddingTop:"30px" }}
            >
              Welcome, Admin
            </Typography>
            <Typography
            ...
            >
              Fill the form to add an institute into the Credentials Ethereum Blockchain
              below
            </Typography>
          </>
        ) : (
                ...
                <Paper className={classes.paper}>
                  ...
                  >
                    <CardContent style={{ textAlign: "center" }}>
                      <Typography variant="h5" color="#800020">
                  ...
                  >
                    ...
                    <Button
                      ...
                      fullWidth
                      variant="outlined"
                      style={{color:"#800020", fontSize: "700", borderColor:"#800020"}}
                    ...
                    <Button
                      ...
                      color="primary"
                      className={classes.submit}
                      style={{color:"white", fontSize: "700", backgroundColor:"#800020"}}
                    >
                      Add Institute
                    </Button>
