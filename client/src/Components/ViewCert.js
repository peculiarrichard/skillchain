  ...
  return (
    ...
    <div style={{background:"#800020"}}>
      ...
      <Typography
        ...
        style={{ marginTop: "30px", color:"white" }}
      >
        Enter the certificate id to view the Verified Certificate
      ...
      >
        <Paper className={classes.paper} style={{ borderRadius: "10px" }}>
          ...
          >
            <CardContent style={{ textAlign: "center", color:"#800020" }}>
              ...
              <Fade in={certId ? true : false} timeout={700}>
                <Box display="flex">
                  <Button
                    ...
                    style={{ marginRight: "10px", background:"#800020", color:"white"}}
                  >
                    Copy link
                  </Button>
                  <Button
