            ...
            <Grid container align="center" justify="center" alignItems="center" >
              <Grid item xs={8} sm={8}>
                <Typography
                  ...
                  // color="primary"
                  align="center"
                  style={{ marginTop: "30px", color:"white", fontWeight:"800" }}
                >
                  Welcome, Institute
                </Typography>
                <Typography
                ...
                >
                  Create or revoke a certificate for your students on the Credentials
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Typography variant="subtitle1">
                            Enter the certificate details below to generate a
                            certificate
                          </Typography>
                        </Grid>
                        <Grid item xs={12} sm={12}>
